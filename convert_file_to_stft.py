...
#Test program to make sure the wavfiles
#Were accuaretly being converted as we compared
#The results from this program to the information
#Provided by Audacity
...
sound = AudioSegment.from_mp3("test_song1.mp3")
